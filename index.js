...
function get20s(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    let birth = arr[i].years.slice(0, 4);

    let death = arr[i].years.slice(6, 11)
...
let newArtist = {
  ...
  bio: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce iaculis luctus neque, non molestie nisl sollicitudin ut. Cras tincidunt feugiat purus, in ornare dui ultrices scelerisque. In hac habitasse platea dictumst. Praesent aliquam magna ac neque consectetur fringilla. Cras augue neque, ultricies varius libero vel, semper venenatis nibh."
}
...
// NOTE: is not returning the list specified above because the previous code removes Amedeo Modigliani from the list
